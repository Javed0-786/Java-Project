...
class ViewMarksWindow extends JFrame {
    ...
    public ViewMarksWindow(String Reg_no) {
        ...
        JPanel panel = new JPanel(new GridLayout(15, 7));
        ...
        try {
            do {
                ...
                panel.add(new JLabel(rs1.getString("CA1")));
                panel.add(new JLabel(rs1.getString("CA2")));
                panel.add(new JLabel(rs1.getString("CA3")));
                panel.add(new JLabel(rs1.getString("MTE")));
                panel.add(new JLabel(rs1.getString("ETE")));
            } while (rs1.next());
